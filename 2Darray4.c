...
Programs on 2D Array:
 Q.Creat a 2D array(matrix) of order r1xc1 and r2xc2 and find division of these 2 arrays.
*/
#include<stdio.h>
int main()
{
    ...
    {
        printf("\nOrders Are Not Same Division not Performed");
    }
